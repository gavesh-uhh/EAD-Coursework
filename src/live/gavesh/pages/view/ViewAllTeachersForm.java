 ...
 * @author gav
 */
public class ViewAllTeachersForm extends JFrame {
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        if (filteredTeachers.isEmpty()) {
            ...
            filteredTeachers.forEach(teacher -> {
                listModel.addElement(teacher.getFullName());
            });
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        if (selectedIndex != -1) {
            String selectedTeacherName = (String) listModel.getElementAt(selectedIndex);
            int confirm = JOptionPane.showConfirmDialog(this,
                    "Are you sure you want to delete " + selectedTeacherName + "?",
                    "Confirm Deletion", JOptionPane.YES_NO_OPTION);

            if (confirm == JOptionPane.YES_OPTION) {
                int teacherID = DatabaseHelper.getTeacherIDByName(selectedTeacherName);
                boolean deleted = DatabaseHelper.deleteTeacher(teacherID);
                if (deleted) {
                    listModel.remove(selectedIndex);
                    JOptionPane.showMessageDialog(this, selectedTeacherName + " deleted successfully!");
                } else {
